...
@WebServlet(name = "CT_UserUpdate", urlPatterns = "/CT_UserUpdate")
public class CT_UserUpdate extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if( username!=null || password !=null || groupid !=null || permission !=null ) {
                ...
                RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/admin/user_update.jsp");
                dispatcher.forward(request,response);
            }
        }finally {
            out.close();
