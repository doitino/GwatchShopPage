                        ...
                        <form action="CT_UserUpdate">
                            <div style="margin-left: 400px" class="register-main">
                                <div style="margin-left: -200px;" class="col-md-6 account-left label-input-update">
                                    <label style="" class="label-update">ID tài khoản :<input name="id" placeholder="id" type="number" value="${user.id}"></label>
                                    <label class="label-update">Tên tài khoản :<input name="username" placeholder="username" type="text" value="${user.username}"></label>
                                    <label class="label-update">Mật khẩu :<input name="password" placeholder="password" type="password" value="${user.password}"></label>
                                    <label class="label-update">Group ID :<input name="groupid" placeholder="groupid" type="number" value="${user.groupId}"></label>
                                    <label class="label-update">Permission:<input name="permission" placeholder="permission" type="number" value="${user.permission}"></label>
