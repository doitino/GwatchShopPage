        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="lienhe.html" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Liên hệ <span class="badge">6</span></a>
